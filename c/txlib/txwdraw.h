...
static TXW_COLORMAP    txwcm_3g =
{
   ...
   TX_Magenta_on_Black,                         // cFileMarkFocus     (DIR/Browser cursor line)
   ...
   TX_Grey_on_Blue,                             // cHexEdHexByteOff
   TX_White_on_Blue,                            // cHexEdAscByteOff
};
...
static TXW_COLORMAP    txwcm_nb =
{
   ...
   TX_Red_on_White,                             // cHexEdModifyText
   TX_Grey_on_Blue,                             // cHexEdHexByteOff
   TX_Grey_on_Blue,                             // cHexEdAscByteOff
};
...
static TXW_COLORMAP    txwcm_cm =
{
   ...
   TX_Yellow_on_Magenta,                        // cHexEdItemHlight
   TX_Red_on_White,                             // cHexEdModifyText
   TX_Cyan_on_Blue,                             // cHexEdHexByteOff
   TX_Green_on_Blue,                            // cHexEdAscByteOff
};
...
static TXW_COLORMAP    txwcm_3w =
{
   ...
   TX_Black_on_White,                           // cHexEdHexByteOff
   TX_Black_on_White,                           // cHexEdAscByteOff
};
