...
// Author: J. van Wijk
//
// JvW  19-04-2017 Added  RETN64 macro
...
#define TXMAXLN             512                 // max line/path length
#define TXMAXTM             128                 // max small line length
#define TXMAXTT              64                 // max giant word length
#define TXMAXTS              32                 // max small text length
...
#define ANSICOLORS        0x100                 // number of color indexes

#define NORMAL            0x100                 // reset attributes to default
#define INTENSE           0x101                 // bold or intense (monochrome)
#define CURSOR_UP1        0x102
#define CURSOR_UP2        0x103
#define CURSOR_UP4        0x104
#define CURSOR_UP8        0x105
#define CURSOR_DOWN1      0x106
#define CURSOR_DOWN2      0x107
#define CURSOR_DOWN4      0x108
#define CURSOR_DOWN8      0x109
#define CURSOR_RIGHT1     0x10a
#define CURSOR_RIGHT2     0x10b
#define CURSOR_RIGHT4     0x10c
#define CURSOR_RIGHT8     0x10d
#define CURSOR_LEFT1      0x10e
#define CURSOR_LEFT2      0x10f
#define CURSOR_LEFT4      0x110
#define CURSOR_LEFT8      0x111
#define CURSOR_SAVEP      0x112
#define CURSOR_RESTP      0x113
#define CLEAR_TO_EOL      0x114
#define CURS_GO_1_70      0x115
#define CURS_GO_1_75      0x116
#define CURS_GO_1_01      0x117
#define CURS_GO_2_01      0x118
#define CURS_GO23_01      0x119
#define CURS_GO24_01      0x11a

#define NUMBER_ANSIS      0x11b

typedef char           ANSISTRING[24];          // enough for 88/256 palette FG+BG combo

//- default monochrome FG+BG color
#define TXaMONOCHROME     TXaNWnZ
...
#define RETN64(rc)                                                  \
   ...
   {                                                                \
      DEVICE_STATE tss = TxScreenState(DEVICE_TEST);                \
      if (TxTrLogOnly)   TxScreenState(DEVICE_OFF);                 \
      TxTraceRetn64( (char *) __FUNCTION__, (ULN64) rc);            \
      if (TxTrLogOnly)   TxScreenState(tss);                        \
   }                                                                \
   return(rc)
...
// JvW 20140625: Seems that EOLN is often incorrect for TRACE to file only
//               But ignoring LogOnly leads to scrollbuf corruption!

#define TREOLN (((TxTrLevel >= 10) && (!TxTrLogOnly)) ? "\n" : "")
#define TRNOLN (((TxTrLevel <  10) || ( TxTrLogOnly)) ? "\n" : "")

// EOLN when tracing only
#define TXREOLN()                                                   \
   {                                                                \
...
#define TxEXITmain(retc)                                            \
   {                                                                \
      BOOL resetTerm = TxaExeSwitchSet(TXA_O_RESET);                \
      TxaDropParsedCommand( TRUE);                                  \
      TxLibraryExit( );                                             \
   }                                                                \
   return((int) retc);
...
// Handle 32bit numeric return of a routine
void TxTraceReturn
(
   char              *mod,                      // IN    module/function name
...
// Handle 64bit numeric return of a routine
void TxTraceRetn64
(
   char              *mod,                      // IN    module/function name
...
// Test character to see if it is printable, pure ASCII range, with withespace
